...
namespace ServiciosEscuelaConduccion.Model.Managements 
{
	...
	public partial class SALARIOMINIMOManagement
	{
		AccessDB conexion;
		SqlConnection conn;	
	
		public SALARIOMINIMOManagement() 
		{
			crearObjetos();
		}
