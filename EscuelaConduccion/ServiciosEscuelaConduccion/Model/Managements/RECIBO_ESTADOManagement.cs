...
namespace ServiciosEscuelaConduccion.Model.Managements 
{
	...
	public partial class RECIBO_ESTADOManagement
	{
		AccessDB conexion;
		SqlConnection conn;	
	
		public RECIBO_ESTADOManagement() 
		{
			crearObjetos();
		}
		 ...
		 * @param RECIBO_ESTADO obj
		 * @return Retorna el mismo objeto pero con la llave primaria configurada
		 */
		public RECIBO_ESTADO crearRECIBO_ESTADO(RECIBO_ESTADO obj) 
		{
			List<RECIBO_ESTADO> lista = null;
			try 
			{
				RECIBO_ESTADODao dao = new RECIBO_ESTADODao();
